...
\begin{itemize}
    ...
    \item \texttt{Entry} -- Được chấm bởi -- \texttt{AppUser} (N-N): Mỗi cặp bài và giám khảo có một phiếu chấm mang trạng thái chốt và nhận xét. Phiếu chấm có vòng đời riêng và còn tham gia mối quan hệ với \texttt{Criterion}, nên được biểu diễn thành thực thể \texttt{ScoreSheet}, nối với \texttt{Entry} qua mối quan hệ Có phiếu và với giám khảo qua mối quan hệ Lập phiếu.
...
Toàn bộ các mối quan hệ trên được thể hiện trên sơ đồ ERD ở mục tiếp theo (Hình~\ref{fig:erd}); lược đồ logic và sơ đồ thiết kế vật lý tương ứng nằm ở Hình 3.1 và Hình 4.1.
